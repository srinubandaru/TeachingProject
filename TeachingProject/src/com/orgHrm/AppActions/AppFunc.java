...
public class AppFunc
{
	...
	// This Close method you can use at the last all your actions done on browser
	...
	public void login(String un,String pwd)
	{
		...
		if (title.equals("OrangeHRM"))
		{
		 ...
		 objun=driver.findElement(By.id("txtUsername"));
		 objpwd=driver.findElement(By.id("txtPassword"));
		 objlogin=driver.findElement(By.id("btnLogin"));
	...
	public void empcreation(String FN,String LN) throws InterruptedException, IOException
	{
		...
		if (emptext.equals("Add Employee")) {
			
			Reporter.log("Add Employee page is displayed");
			
		}else {
			
			Reporter.log("Add Employee page is not displayed");
		...
		//Thread.sleep(4000);
		//AutoIt
		Runtime.getRuntime().exec("dataFiles/HRMFileUpload.exe");
		Thread.sleep(6000);
